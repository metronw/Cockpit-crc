    ...
    <form action={nextPage} className="flex flex-col flex-stretch px-2 pt-2 mt-2 h-full grow justify-around">
      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col gap-4 my-1">
          <Snippet hideSymbol className="bg-purple-700 text-white rounded content-center px-2 my-1 py-1"><span className="bg-purple-700 text-white rounded content-center px-2 my-1 py-1 ">{`Bom dia. Meu nome é ${session?.user.name.split(' ')[0]}, com quem falo?`}</span></Snippet>
